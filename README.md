...
**DSA** is the clearest case here: revenue fell 2.0% and the organic growth bridge confirms this wasn't a currency effect — organic growth was -3.1%, driven by softer discovery services volume and safety assessment demand. This is the one segment where the numbers point to genuine underlying softness rather than an accounting artefact.
